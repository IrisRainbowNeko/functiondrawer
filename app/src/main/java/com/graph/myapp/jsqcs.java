...
public class jsqcs extends Activity implements OnClickListener,OnLongClickListener
{
	EditText t1,t2,t3,t4,et;
    ...
    public void onCreate(Bundle savedInstanceState)
	{
		...
		this.lv = (ListView) findViewById(R.id.jsqListView1);
        this.gd = (GridView) findViewById(R.id.jsqGridView1);
        this.gd1 = (GridView) findViewById(R.id.jsqGridView2);
        this.b0 = (Button) findViewById(R.id.jsqButton00);
        this.b1 = (Button) findViewById(R.id.jsqButton01);
        this.b2 = (Button) findViewById(R.id.jsqButton02);
        this.b3 = (Button) findViewById(R.id.jsqButton03);
        this.b4 = (Button) findViewById(R.id.jsqButton04);
        this.b5 = (Button) findViewById(R.id.jsqButton05);
        this.b6 = (Button) findViewById(R.id.jsqButton06);
        this.b7 = (Button) findViewById(R.id.jsqButton07);
        this.b8 = (Button) findViewById(R.id.jsqButton08);
        this.b9 = (Button) findViewById(R.id.jsqButton09);
        this.tg = (Button) findViewById(R.id.jsqButtontg);
        this.xs = (Button) findViewById(R.id.jxianshi);
		...
		final String[] bs="t + - * / ^ √ π e . , ( ) a b c m n".split(" ");
		...
		t1 = (EditText) findViewById(R.id.jsqEditText1);
        t2 = (EditText) findViewById(R.id.jsqEditText2);
        t3 = (EditText) findViewById(R.id.jsqcsEditText1);
        t4 = (EditText) findViewById(R.id.jsqcsEditText2);
		String[] split=gra.suan.get(which).split(";");
		if(split.length==4){
        t1.setText(split[0].substring(2+prefix.length()));
        t2.setText(split[1].substring(3));
        t3.setText(split[2]);
        t4.setText(split[3]);}
	...
	public void onjsqyes(View view)
	{
		String s1=t1.getText().toString();
		String s2=t2.getText().toString();
		String s3=t3.getText().toString();
		String s4=t4.getText().toString();
		gra.suan.setElementAt(prefix+"x="+s1+";\ny="+s2+";"+s3+";"+s4,which);
        try {
			s1=gra.ex.doTrans(s1);
			s2=gra.ex.doTrans(s2);
			String[] st4=s4.split(",");
			st4[0]=gra.ex.doTrans(st4[0]);
			st4[1]=gra.ex.doTrans(st4[1]);
			gra.ex.setexpress(new String[]{s1,s2},Express.arr2buff(new double[1+Constant.PARA_strarr.length]),tool.arrayadd(new String[]{"t"},Constant.PARA_strarr));
			gra.ex.calculate0check(0);
			gra.ex.calculate0check(1);
			gra.ex.setexpress(new String[]{st4[0],st4[1]},Express.arr2buff(new double[Constant.PARA_strarr.length]),Constant.PARA_strarr);
			gra.ex.calculate0check(0);
			gra.ex.calculate0check(1);
			s4=st4[0]+","+st4[1];
            gra.suanshi.setElementAt("1;"+s1+";"+s2+";"+s3+";"+s4,which);
